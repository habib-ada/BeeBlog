...
<html lang="en">
    ...
    <body>
        ...
        <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="{{ route('start') }}">BeeBlog</a>
        ...
        <div class="container-fluid">
            <div class="row">
                <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                    <div class="sidebar-sticky" bis_skin_checked="1">
                      <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="{{ route('showArticles') }}">
